...
Deepfake Trace employs a multi-model approach, combining insights from various AI models to enhance detection accuracy and provide a more reliable assessment of video authenticity. This feature allows for:
...
```
git clone https://github.com/ShivamAgarwal-code/DeepFake-Trace.git
npm i
npm run dev
cd Backend
npm i
